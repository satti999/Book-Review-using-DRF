...
SECRET_KEY = 'django-insecure-9k4_w=^&c%egt5i$tjd^a*6*$n(fce+#=kj6ahtzigcjs*$t)_'
...
EMAIL_HOST_USER = 'samdani.cortechsols@gmail.com'
EMAIL_HOST_PASSWORD = 'supu osgr etjx crsk'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
